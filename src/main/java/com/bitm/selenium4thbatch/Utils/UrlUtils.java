...
public class UrlUtils {
	...
	public static final String BOOK_FLIGHT_URL ="http://newtours.demoaut.com/mercurypurchase.php";
	public static final String BOOK_FLIGHT_PAGE_TITLE="Book a Flight: Mercury Tours";
	
	
	public static final String FLIGHT_CONFIRMATION_PAGE_TITLE="Flight Confirmation: Mercury Tours";
}
